...
\wolfgang{Which operations do we need exactly?
Just very basic ones? Only AC(0) operations? Multiplication?}
...
prefix of $q$. One $|e|$ is known, the name 
of $\exit(q)$ is obtained as $q[0, |e| + 1]$.
...
This makes the search order more
predictable among different initial search intervals 
and thus allows for effective preprocessing in $Z$.
See Algorithm~\ref{algo:query} for details. 
